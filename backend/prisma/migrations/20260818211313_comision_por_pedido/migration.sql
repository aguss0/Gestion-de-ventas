/*
  ...
  - You are about to drop the column `metodo` on the `comisiones` table. All the data in the column will be lost.
...
INSERT INTO "new_comisiones" ("cobrado", "comision_gerardo", "comision_miguel", "comision_turko", "creado_en", "fecha_cobro", "id", "importe", "pedido_id", "plus_turko", "vendedor_id") SELECT "cobrado", "comision_gerardo", "comision_miguel", "comision_turko", "creado_en", "fecha_cobro", "id", "importe", "pedido_id", "plus_turko", "vendedor_id" FROM "comisiones";
